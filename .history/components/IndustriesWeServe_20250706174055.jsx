...
// Industry Images
import ResidentialImage from '../public/assets/residential_towers_gated_communities.jpg';
import CommercialImage from '../public/assets/commercial_offices_business_parks.jpg';
import RetailImage from '../public/assets/retail_chains_malls_showrooms.jpg';
import HospitalImage from '../public/assets/hospitals_healthcare_buildings.jpg';
import CollegeImage from '../public/assets/colleges_universities_hostels.jpg';
import GovernmentImage from '../public/assets/government_psu_complexes.jpg';
import IndustrialImage from '../public/assets/industrial_manufacturing_plants.jpg';
import HotelImage from '../public/assets/hotels_resorts_banquet_spaces.jpg';
import WarehouseImage from '../public/assets/warehouses_cold_storage_data_centers.jpg';
                ...
                <div className='absolute inset-0 bg-gray-200 flex items-center justify-center'>
                  <div className='text-center'>
                    <div className='w-16 h-16 bg-gray-300 rounded-full flex items-center justify-center mx-auto mb-2'>
                      <industry.icon className='w-8 h-8 text-gray-500' />
                    </div>
                    <p className='text-sm text-gray-500 font-medium'>{industry.image}</p>
                  </div>
                </div>
