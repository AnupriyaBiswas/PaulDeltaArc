    ...
    >
      ...
      >
        ...
        <div className='mb-8'>
          ...
          <p 
            className={`text-gray-400 text-sm uppercase tracking-wider transition-all duration-600 ${
        ...
        <div className='flex justify-center space-x-2 mb-6'>
          {[0, 1, 2].map((i) => (
            <div
              key={i}
              className={`w-3 h-3 bg-teal-500 rounded-full transition-all duration-500 ${
                isComplete 
              ...
              style={{ 
                ...
                animationDuration: isComplete ? '0.6s' : '1.5s'
              }}
            />
          ))}
        </div>
