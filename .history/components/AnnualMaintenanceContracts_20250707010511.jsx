    ...
    <div className='w-full bg-gradient-to-br from-teal-50 to-cyan-50 py-10 text-sm'>
      <div className='max-w-6xl mx-auto px-4'>
        <div className='text-center mb-10'>
          ...
          <p className='text-sm text-gray-600 max-w-3xl mx-auto'>Comprehensive maintenance solutions to keep your fire safety systems running at peak performance</p>
        </div>

        <div className='mb-10 flex flex-col lg:flex-row gap-6'>
          <div className='lg:w-1/2 max-h-[420px] overflow-y-auto pr-2'>
          ...
          <div className='lg:w-1/2'>
            <div className='bg-white rounded-xl shadow-md p-6 min-h-[420px]'>
        ...
        <div className='mb-10'>
          <div className='text-center mb-6'>
            ...
            <p className='text-sm text-gray-600 max-w-xl mx-auto'>Experience the peace of mind that comes with professional maintenance and support</p>
          </div>
          ...
          <div className='grid grid-cols-1 md:grid-cols-3 gap-4'>
            {benefits.map((benefit, index) => (
              ...
              >
                ...
                <p className='text-[11px] text-gray-600 text-center leading-relaxed'>{benefit.description}</p>
              </div>
            ))}
          </div>
        </div>
