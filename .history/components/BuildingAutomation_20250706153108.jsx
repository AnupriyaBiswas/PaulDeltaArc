...
const BuildingAutomation = () => {
  ...
  const platforms = [
    { name: "Honeywell", icon: "honeywell.jpg", specialty: "Industrial Control" },
    { name: "Siemens", icon: "siemens.jpg", specialty: "Building Technologies" },
    { name: "Schneider", icon: "schneider.jpg", specialty: "Energy Management" },
    { name: "Johnson Controls", icon: "johnson_controls.jpg", specialty: "Smart Buildings" }
  ];
