...
const BuildingAutomation = () => {
  ...
  return (
    <div id='building-automation' className='w-full bg-gradient-to-br from-teal-50 to-cyan-50 py-8 min-h-screen text-sm'>
            ...
            <div className='relative z-10 grid grid-cols-1 md:grid-cols-2 gap-4 items-center'>
              ...
              <div className='grid grid-cols-2 md:grid-cols-3 gap-3'>
                {scopeServices.map((service, index) => (
                  <div key={index} className='bg-gradient-to-br from-teal-100 to-cyan-100 p-4 rounded-xl text-center h-28 flex flex-col justify-center items-center'>
                    <div className='text-xl mb-1'>{service.icon}</div>
                    <h3 className='text-xs font-semibold text-[#2c3e50] text-center'>{service.title}</h3>
                  </div>
                ))}
              </div>
            </div>
