...
const IndustriesWeServe = () => {
  return (
    <div id='industries-we-serve' className="w-full bg-gradient-to-br from-teal-50 to-cyan-50 py-4 px-2 md:px-10 min-h-screen flex flex-col justify-center items-center">
      {/* Header */}
