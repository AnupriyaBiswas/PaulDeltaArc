...
const BuildingAutomation = () => {
  ...
  const platforms = [
    { name: "Honeywell", icon: "🔶", specialty: "Industrial Control" },
    { name: "Siemens", icon: "🔷", specialty: "Building Technologies" },
    { name: "Schneider", icon: "🟢", specialty: "Energy Management" },
    { name: "Johnson Controls", icon: "🔴", specialty: "Smart Buildings" }
  ];
