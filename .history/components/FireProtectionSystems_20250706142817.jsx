      ...
      <div className='max-w-[1400px] mx-auto px-4 w-full'>
        ...
        <div className='text-center'>
          <div className='bg-white rounded-2xl p-6 shadow-lg border border-gray-100'>
            <h3 className='text-xl font-bold text-[#2c3e50] mb-2'>Comprehensive Fire Safety Solutions</h3>
            <p className='text-gray-600 text-sm max-w-4xl mx-auto'>
              From design and installation to testing and maintenance, we provide end-to-end fire protection services 
              ensuring compliance with all safety standards and regulations for maximum protection of life and property.
            </p>
          </div>
        </div>
      </div>
