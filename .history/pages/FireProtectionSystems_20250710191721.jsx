  ...
  return (
    <>
      <div
        ...
        className='w-full bg-gradient-to-br from-teal-50 to-cyan-50 py-4 min-h-screen flex items-center'
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-6'>
            <div className='group relative p-4 bg-white shadow-lg rounded-2xl hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-100 lg:col-span-3'>
              ...
              <div className='relative z-10'>
                <h3 className='text-base font-bold text-[#2c3e50] group-hover:text-white transition-colors duration-300 mb-3 text-center'>Target Clients:</h3>

                <div className='grid grid-cols-5 gap-2'>
                  <div className='text-center'>
                    <div className='text-3xl mb-3 group-hover:scale-110 transition-transform duration-300'>🏢</div>
                    <p className='text-sm font-medium text-gray-600 group-hover:text-white transition-colors duration-300'>Residential Towers</p>
                  </div>
                  <div className='text-center'>
                    <div className='text-3xl mb-3 group-hover:scale-110 transition-transform duration-300'>🏭</div>
                    <p className='text-sm font-medium text-gray-600 group-hover:text-white transition-colors duration-300'>Industrial Plants</p>
                  </div>
                  <div className='text-center'>
                    <div className='text-3xl mb-3 group-hover:scale-110 transition-transform duration-300'>🖥️</div>
                    <p className='text-sm font-medium text-gray-600 group-hover:text-white transition-colors duration-300'>Data Centers</p>
                  </div>
                  <div className='text-center'>
                    <div className='text-3xl mb-3 group-hover:scale-110 transition-transform duration-300'>🏥</div>
                    <p className='text-sm font-medium text-gray-600 group-hover:text-white transition-colors duration-300'>Hospitals</p>
                  </div>
                  <div className='text-center'>
                    <div className='text-3xl mb-3 group-hover:scale-110 transition-transform duration-300'>🛍️</div>
                    <p className='text-sm font-medium text-gray-600 group-hover:text-white transition-colors duration-300'>Malls</p>
                  </div>
                </div>
              </div>
