    ...
    <div id='about' className='w-full bg-gradient-to-br from-teal-50 to-cyan-50 py-8 px-4 min-h-screen flex items-center'>
      <div className='max-w-7xl mx-auto w-full'>
        ...
        <div className='grid md:grid-cols-2 gap-6 mb-8'>
          {/* Driving Forces - Left Half */}
          <div className='bg-white rounded-xl p-5 shadow'>
            <h3 className='text-lg font-bold text-[#2c3e50] flex items-center mb-3'>
        ...
        <div className='grid grid-cols-1 sm:grid-cols-3 gap-6 text-center'>
          <div>
            <div className='w-10 h-10 bg-gradient-to-br from-teal-400 to-cyan-600 rounded-full flex items-center justify-center mx-auto mb-2'>
          ...
          <div>
            <div className='w-10 h-10 bg-gradient-to-br from-orange-400 to-red-600 rounded-full flex items-center justify-center mx-auto mb-2'>
