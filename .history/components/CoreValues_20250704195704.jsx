  ...
  return (
    <div id='core-values' className='w-full bg-gray-50 py-16'>
      <div className='max-w-[1240px] mx-auto px-4'>
        {/* Header */}
        <div className='mb-12'>
          <h2 className='text-4xl font-bold text-[#2c3e50] mb-2'>Core</h2>
          <h2 className='text-4xl font-bold text-[#2c3e50] mb-4'>Values</h2>
          <div className='w-16 h-1 bg-[#2c3e50]'></div>
        </div>
