...
const AnnualMaintenanceContracts = () => {
  ...
  return (
    <div className='w-full bg-gradient-to-br from-teal-50 to-cyan-50 py-10 text-sm'>
      <div className='max-w-6xl mx-auto px-4'>
        <div className='text-center mb-10'>
          <h1 className='text-3xl md:text-4xl font-bold text-[#2c3e50] mb-4'>📄 Annual Maintenance Contracts</h1>
          ...
          <div className='lg:w-1/3'>
            <div className='sticky top-6'>
              <div className='flex items-center justify-between mb-4'>
                <h2 className='text-lg font-bold text-[#2c3e50]'>Our Services</h2>
                <button
          ...
          <div className='lg:w-2/3'>
            <div className='bg-white rounded-xl shadow-md p-6 min-h-[480px]'>
              <div className='flex items-center space-x-4 mb-4'>
                <div className='w-12 h-12 bg-gradient-to-br from-teal-400 to-cyan-600 rounded-full flex items-center justify-center text-xl'>
              ...
              <div className='border-t pt-4'>
                <p className='text-sm text-gray-700 mb-4 leading-relaxed'>{amcServices[activeTab].details}</p>

                <h4 className='text-sm font-semibold text-[#2c3e50] mb-3'>Key Features:</h4>
              ...
              <div className='mt-6 pt-4 border-t'>
                <div className='flex justify-between items-center mb-1'>
                  <span className='text-[10px] text-gray-500'>Service {activeTab + 1} of {amcServices.length}</span>
        ...
        <div className='mb-10'>
          <div className='text-center mb-6'>
            <h2 className='text-2xl font-bold text-[#2c3e50] mb-2'>Why Choose Our AMC Services?</h2>
          ...
          <div className='grid grid-cols-1 md:grid-cols-3 gap-6'>
            {benefits.map((benefit, index) => (
              <div
                key={index}
                className='group bg-white p-6 rounded-xl shadow border border-gray-200 hover:shadow-md transition-all duration-300 hover:-translate-y-1'
              >
                <div className={`w-12 h-12 bg-gradient-to-br ${benefit.color} rounded-full flex items-center justify-center mx-auto mb-4 group-hover:scale-105 transition-transform duration-300`}>
                  <benefit.icon className='w-6 h-6 text-white' />
                </div>
                <h4 className='text-sm font-semibold text-[#2c3e50] mb-2 text-center'>{benefit.title}</h4>
                <p className='text-xs text-gray-600 text-center leading-relaxed'>{benefit.description}</p>
              </div>
            ))}
          </div>
        </div>

        <div className='text-center bg-gradient-to-r from-teal-400 to-cyan-600 rounded-xl p-8 text-white'>
          ...
          <button className='bg-white text-teal-600 px-6 py-2 rounded-full font-semibold text-sm hover:bg-gray-100 transition-colors duration-300 shadow'>
            Request Quote
          </button>
        </div>
      </div>
