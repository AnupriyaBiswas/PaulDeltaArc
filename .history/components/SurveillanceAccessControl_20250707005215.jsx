          ...
          <div className='bg-white rounded-2xl shadow p-8 relative overflow-hidden'>
            ...
            <div className='relative z-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 items-stretch'>
              {scopeServices.map((service, index) => (
                <div key={index} className='group relative 0'>
                  <div className='bg-white p-6 rounded-xl shadow-md hover:shadow-xl transition-all duration-300 transform group-hover:-translate-y-10 border border-gray-100 group-hover:border-teal-200 h-full flex flex-col items-center justify-center text-center'>
