      ...
      <div className='max-w-[1400px] mx-auto px-6 w-full'>
        ...
        <div className='grid grid-cols-1 lg:grid-cols-2 gap-12 items-stretch'>
          ...
          <div className='order-1 lg:order-1'>
            <div className='group relative bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1 border border-gray-100 overflow-hidden h-[450px]'>
