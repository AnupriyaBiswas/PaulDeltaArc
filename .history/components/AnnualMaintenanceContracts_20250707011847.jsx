...
const AnnualMaintenanceContracts = () => {
  ...
  useEffect(() => {
    if (serviceRefs.current[activeTab]) {
      serviceRefs.current[activeTab].scrollIntoView({ behavior: 'smooth', block: 'nearest' });
    }
  }, [activeTab]);
    ...
    <div className='w-full bg-gradient-to-br from-teal-50 to-cyan-50 py-8 text-sm'>
      <div className='max-w-7xl mx-auto px-4'>
        ...
        <div className='mb-8 flex flex-col lg:flex-row gap-4'>
          <div className='lg:w-1/2 max-h-[250px] overflow-y-auto pr-2'>
            <div className='sticky top-6 bg-teal-50 z-10 pb-2'>
