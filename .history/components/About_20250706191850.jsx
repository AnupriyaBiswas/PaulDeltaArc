...
const About = () => {
  ...
  return (
    <div id='about' className='w-full bg-gradient-to-br from-teal-50 to-cyan-50 py-12 px-4'>
      <div className='max-w-7xl mx-auto'>
        ...
        <div className='grid md:grid-cols-2 gap-8 items-center mb-12'>
          ...
          <div className='relative group'>
            ...
            <div className='relative bg-white rounded-xl p-2 shadow-lg'>
              <div className='h-60 flex items-center justify-center bg-gradient-to-br from-teal-100 to-cyan-100 rounded-lg'>
                <div className='text-center text-teal-600'>
                  <Building className='w-16 h-16 mx-auto mb-2' />
                  <h3 className='text-xl font-bold'>MEP Engineering</h3>
          ...
          <div className='space-y-4'>
            <h2 className='text-2xl font-bold text-[#2c3e50]'>Leading MEP Solutions Provider</h2>
        ...
        <div className='bg-white rounded-xl p-6 shadow mb-12'>
          <h3 className='text-lg font-bold text-[#2c3e50] flex items-center mb-4'>
            <Target className='w-5 h-5 mr-2 text-teal-600' /> We are driven by
          </h3>
          <ul className='space-y-2'>
            {drivingForces.map((force, idx) => (
              <li key={idx} className='flex items-start text-sm text-gray-700'>
                <CheckCircle className='w-4 h-4 text-teal-500 mt-1 mr-2 flex-shrink-0' />
                {force}
              </li>
            ))}
          </ul>
        ...
        <div className='grid grid-cols-2 md:grid-cols-4 gap-4 mb-12'>
          {services.map((service, i) => (
            ...
            >
              <div className={`w-12 h-12 bg-gradient-to-br ${service.color} rounded-xl flex items-center justify-center mb-3 transition-transform duration-300 ${
        ...
        <div className='grid grid-cols-1 sm:grid-cols-3 gap-6 text-center'>
          <div>
            <div className='w-12 h-12 bg-gradient-to-br from-teal-400 to-cyan-600 rounded-full flex items-center justify-center mx-auto mb-2'>
              <Users className='w-6 h-6 text-white' />
            </div>
            <h4 className='text-base font-bold text-[#2c3e50]'>Pan-India</h4>
            <p className='text-sm text-gray-600'>Service Coverage</p>
          </div>
          <div>
            <div className='w-12 h-12 bg-gradient-to-br from-purple-400 to-pink-600 rounded-full flex items-center justify-center mx-auto mb-2'>
              <Award className='w-6 h-6 text-white' />
            </div>
            <h4 className='text-base font-bold text-[#2c3e50]'>Complete EPC</h4>
            <p className='text-sm text-gray-600'>Lifecycle Solutions</p>
          </div>
          <div>
            <div className='w-12 h-12 bg-gradient-to-br from-orange-400 to-red-600 rounded-full flex items-center justify-center mx-auto mb-2'>
              <Shield className='w-6 h-6 text-white' />
            </div>
            <h4 className='text-base font-bold text-[#2c3e50]'>Multi-Sector</h4>
