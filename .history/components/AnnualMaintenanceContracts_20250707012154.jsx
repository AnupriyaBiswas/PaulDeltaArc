...
const AnnualMaintenanceContracts = () => {
  ...
  return (
    <div className='w-full bg-gradient-to-br from-teal-50 to-cyan-50 py-6 text-sm'>
      <div className='max-w-7xl mx-auto px-4'>
        ...
        <div className='mb-6 flex flex-col lg:flex-row gap-4'>
          <div className='lg:w-1/2 max-h-[180px] overflow-y-auto pr-2' ref={scrollContainerRef}>
          ...
          <div className='lg:w-1/2'>
            <div className='bg-white rounded-xl shadow-md p-4 min-h-[180px]'>
              <div className='flex items-center space-x-4 mb-2'>
                <div className='w-8 h-8 bg-gradient-to-br from-teal-400 to-cyan-600 rounded-full flex items-center justify-center text-sm'>
              ...
              <div className='border-t pt-2'>
                <p className='text-xs text-gray-700 mb-2 leading-relaxed'>{amcServices[activeTab].details}</p>
                <h4 className='text-xs font-semibold text-[#2c3e50] mb-1'>Key Features:</h4>
