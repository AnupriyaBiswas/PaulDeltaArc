...
const Main = () => {
  ...
  return (
    <div id='home' className='w-full h-screen text-center relative overflow-hidden bg-gradient-to-br from-teal-50 via-pink-50 to-purple-50'>
      ...
      <div className='max-w-[1240px] w-full h-full mx-auto p-2 flex justify-center items-center relative z-10'>
        <div>
          <h1 className='py-4 text-gray-800 text-5xl md:text-6xl font-bold tracking-wide drop-shadow-lg'>
            <span className='inline-block animate-pulse bg-gradient-to-r from-teal-600 via-pink-300 to-purple-600 bg-clip-text text-transparent'>Paul Delta Arc</span>
          </h1>
