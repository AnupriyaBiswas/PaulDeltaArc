...
const VisionMission = () => {
  return (
    <div id='vision-mission' className='w-full bg-gray-50 py-8 min-h-screen flex items-center' style={{paddingTop: '80px'}}>
      <div className='max-w-[1400px] mx-auto px-6 w-full'>
        ...
        <div className='grid grid-cols-1 lg:grid-cols-2 gap-12 items-stretch'>
          ...
          <div className='order-1 lg:order-1'>
            <div className='group relative bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1 border border-gray-100 overflow-hidden min-h-[320px]'>
        ...
        <div className='mt-12 text-center'>
          <div className='inline-flex items-center space-x-2 text-gray-400'>
            ...
            <span className='text-sm'>Building Excellence Together</span>
            <div className='w-8 h-px bg-gradient-to-l from-transparent to-teal-400'></div>
          </div>
        </div>
      </div>
    </div>
