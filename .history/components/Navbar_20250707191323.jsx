...
const Navbar = () => {
  ...
  return (
    <div
      className={
        shadow
          ? 'fixed w-full h-12 shadow-2xl z-[100] ease-in-out duration-300 bg-gradient-to-br from-teal-50 to-cyan-50 bg-opacity-90 backdrop-blur-sm border-b border-gray-100'
