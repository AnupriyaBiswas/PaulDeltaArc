...
const Contact = () => {
  ...
  return (
    <div id='contact' className='w-full h-screen bg-gradient-to-br from-teal-50 to-cyan-50 flex items-center justify-center p-4'>
            ...
            <div className='relative z-10'>
              ...
              <div className='space-y-4'>
                <div className='flex items-center'>
                  ...
                  <div>
                    <p className='font-medium'>+91 7439556612</p>
                    <p className='font-medium'>+91 6291463644</p>
                  </div>
                </div>
                ...
                <div className='flex items-center'>
                  ...
                  <div>
                    <p className='font-medium'>www.pauldeltaarc.com</p>
                  </div>
                </div>
                ...
                <div className='flex items-center'>
                  ...
                  <div>
                    <p className='font-medium'>Jagannath Apartment, Arunachal, Sodepur,</p>
                    <p className='font-medium'>Kolkata - 700110, West Bengal, India</p>
                  </div>
                </div>
              </div>
