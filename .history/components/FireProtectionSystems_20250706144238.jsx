    ...
    <div id='fire-protection-systems' className='w-full bg-gray-50 py-4 min-h-screen flex items-center' style={{paddingTop: '80px'}}>
      <div className='max-w-[1400px] mx-auto px-4 w-full'>
        ...
        <div className='flex justify-center'>
          <div className='group relative p-4 bg-white shadow-lg rounded-2xl hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-100 w-full max-w-[calc(100%-2rem)] lg:max-w-[calc(100%-4rem)]'>
            {/* Background gradient on hover */}
            <div className='absolute inset-0 bg-gradient-to-br from-teal-400 to-teal-600 rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-300'></div>
            
            {/* Content */}
            <div className='relative z-10 text-center'>
              <h3 className='text-sm font-bold text-[#2c3e50] group-hover:text-white transition-colors duration-300 mb-5'>Target Clients:</h3>
