...
const ElectricalSystemsVentilation = () => {
  ...
  const scopeServices = [
    ...
    { icon: "🔌", title: "Main/Sub Switchboards", subtitle: "PCC, MCC, APFC panels", description: "Power & Motor Control Centers with APFC integration" },
  ...
  return (
    <div id='electrical-systems-ventilation' className='w-full bg-gradient-to-br from-teal-50 to-cyan-50 py-4 min-h-screen flex items-center' style={{paddingTop: '80px'}}>
      <div className='max-w-[1400px] mx-auto px-4 w-full'>
        ...
        {/* Specializations Section - Special Style */}
        <div className='mb-4'>
          {/* Special Header with Enhanced Styling */}
