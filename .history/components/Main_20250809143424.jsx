...
const Main = () => {
  ...
  useEffect(() => {
    // Delayed visibility for smooth loader transition
  ...
  return (
    <div 
      id='home' 
      className={`w-full h-screen relative overflow-hidden bg-gradient-to-br from-slate-900 via-slate-800 to-teal-900 transition-opacity duration-1000 ${
    ...
    >
      ...
      <div className='max-w-[1240px] w-full h-full mx-auto p-4 flex justify-center items-center relative z-10'>
        <div className='text-center max-w-4xl'>
          {/* Professional Badge */}
          <div className={`inline-flex items-center px-4 py-2 mb-6 bg-teal-500/10 border border-teal-500/20 rounded-full backdrop-blur-sm transition-all duration-1000 delay-300 ${
          ...
          <h1 className='mb-6 text-white'>
            <div className={`text-4xl md:text-6xl lg:text-7xl font-bold tracking-tight leading-tight mb-4 transition-all duration-1000 delay-500 ${
              isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
            }`}>
              <span className='block bg-gradient-to-r from-white via-teal-100 to-white bg-clip-text text-transparent'>
                Turnkey MEP
              </span>
              <span className={`block bg-gradient-to-r from-teal-400 via-teal-300 to-cyan-400 bg-clip-text text-transparent animate-pulse transition-all duration-1000 delay-700 ${
                isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
              }`}>
          ...
          <p className={`text-xl md:text-2xl text-gray-300 font-light tracking-wide mb-8 max-w-3xl mx-auto leading-relaxed transition-all duration-1000 delay-900 ${
            isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'
          }`}>
          ...
          <p className={`text-gray-400 text-base md:text-lg font-light max-w-2xl mx-auto mb-8 leading-relaxed transition-all duration-1000 delay-1000 ${
            isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'
          }`}>
          ...
          {/* CTA Button */}
          <div className={`flex justify-center transition-all duration-1000 delay-1100 ${
            isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'
          }`}>
            <a
              href='#contact'
          ...
          <div className={`mt-12 flex flex-wrap justify-center items-center gap-8 text-gray-400 text-sm opacity-70 transition-all duration-1000 delay-1200 ${
